										...
										<div className="form-group">
											<div className="input-group">
												<input
													...
													className={`pb-2 form-control text-center border border-bottom  border-top-0 border-end-0 border-start-0 input-outline-none rounded-0 ${!passwordError ? "" : "is-invalid"
														}`}
													id="password"
													name="password"
										...
										<div className="form-group">
											<div className="input-group">
												<input
													...
													className={`pb-2 form-control text-center border border-bottom border-top-0 border-end-0 border-start-0 input-outline-none rounded-0 ${!confirmPasswordError ? "" : "is-invalid"
														}`}
													id="confirmPassword"
