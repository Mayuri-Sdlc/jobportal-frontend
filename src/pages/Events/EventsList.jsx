                ...
                <div className='px-2 sm:px-4'>
                    <div className="overflow-x-auto w-full">
                        ...
                        <div className='flex justify-end'>
                            <button className='bg-[#2626ea] text-white p-2 rounded-md'>Add Event</button>
                        </div>
                                    ...
                                    <table className="divide-y border-secondary-light table-auto min-w-full">
                                        <thead className="border-secondary-light border-b">
                                            <tr>
                                                ...
                                                <th scope="col" className="px-6 py-3 text-lg font-bold text-left text-secondary capitalize">Time</th>
                                                    ...
                                                    <tr key={item.id}>
                                                        ...
                                                        <td className="px-6 py-4 text-lg font-normal text-secondary whitespace-nowrap capitalize text-left">
                                                            <div className='flex gap-3 items-center'>
                                                                ...
                                                                <div>
                                                                    <h1 className='font-normal text-lg text-[#091E42] mr-2 whitespace-nowrap'><Link to={`/events/${item.role.mainRole}/${item.id}`}>{item.firstName} {item.lastName}</Link></h1>
