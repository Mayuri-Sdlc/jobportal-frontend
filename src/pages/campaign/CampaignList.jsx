...
const CampaignList = () => {
    ...
    const openConfirmModal = () => setShowConfirmationModal(true)
                ...
                <div className='px-2 sm:px-4'>
                    <div className="overflow-x-auto w-full">
                        <div className='flex flex-wrap items-center justify-between'>
                            <div className='pt-4'>
                                <h3 className='font-bold text-xl text-secondary'>All Campaigns <span className='text-xl font-bold text-secondary-light'>({campaigns && campaigns?.totalResults ? campaigns.totalResults : 0})</span></h3>
                            </div>
                            <div className='pt-4'>
                                                    ...
                                                    campaigns.results.map((item) => (
                                                        <tr key={item.id}>
                                                            ...
                                                            <td className="flex gap-6 px-6 py-4 text-sm font-medium text-right whitespace-nowrap items-center">
                                                                {(item.isVerified == "approve" || item.isVerified == "pending") ? null: <div className="cursor-pointer" onClick={() => openModal()}>
                                                                ...
                                                                {item.isVerified == "pending" && <><div className="cursor-pointer" onClick={() => { openConfirmModal(); setConfirmationType({ id: item.id, type: "approve" }); }}>
                                                                ...
                                                                <div className="cursor-pointer" onClick={() => { openConfirmModal(); setConfirmationType({ id: item.id, type: "reject" }); }}>
