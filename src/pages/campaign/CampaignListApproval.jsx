...
import { getAllApprovedCampaigns } from '../../features/campaign/campaignSlice'
...
const CampaignListApproval = () => {
    ...
    const { approvedCampaigns: campaigns, isLoading, isError, isSuccess, message } = useSelector((state) => state.campaign)
    console.log('approvedCampaigns', campaigns);
    ...
    const handleApproveCampaign = async (status) => {
        try {
            ...
            if (response.data.status === 200 && response.data.data) {
                ...
                dispatch(getAllApprovedCampaigns(optionsData))
            }
        } catch (error) {
                ...
                <div className='px-2 sm:px-4'>
                    <div className="overflow-x-auto w-full">
                        <div className='flex flex-wrap items-center justify-between'>
                            <div className='pt-4'>
                                <h3 className='font-bold text-xl text-secondary'>Deal Room Campaigns <span className='text-xl font-bold text-secondary-light'>({campaigns && campaigns?.totalResults ? campaigns.totalResults : 0})</span></h3>
                            </div>
                            <div className='pt-4'>
...
export default CampaignListApproval