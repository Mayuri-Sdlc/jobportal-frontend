      ...
      <div className='flex flex-col sm:flex-row w-full gap-6'>
        ...
        <div className='w-full sm:w-1/2 flex flex-col gap-5'>
          ...
          <div className="bg-[#FAFBFB] rounded-lg p-8">
            <div className="font-bold text-xl mr-2 whitespace-nowrap">Campaign Information</div>
            ...
            <div className="flex flex-col sm:flex-row sm:gap-3 mt-3">
              <div className="w-full sm:w-1/2 mb-4">
                ...
                <input
                  ...
                  name="campaignType"
                  disabled
                  value={campaign.isPrivate?"Private":"Public"}
            ...
            <div className="font-bold text-xl mr-2 my-4 whitespace-nowrap">Banner Image</div>
            <img src={campaign?.bannerImage ? campaign?.bannerImage : "https://i.ibb.co/QjYTX7g/Campaign-Banner.png"} />

            <div className="font-bold text-xl mr-2 mb-3 mt-8 whitespace-nowrap">Logo</div>
            <div className='w-1/2'>
              <img src={campaign?.logo ? campaign?.logo : "https://i.ibb.co/pw2j0HS/Campaign-Logo.png"} />
            </div>

            <div className="font-bold text-xl mr-2 mt-8 whitespace-nowrap">Elevator Pitch</div>
            {company?.founderdocFinances && company?.founderdocFinances.length ? company?.founderdocFinances.map((item) => (
              <div className="flex flex-row mt-3 gap-3 items-center">
                <div className='w-full shadow-2xl'>
                  <img src={item?.pitchDeckThumbnail ? item?.pitchDeckThumbnail : "https://i.ibb.co/vBXw72c/Campaign-Startup.png"} />
                </div>
                <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M34.2497 39.8501C34.2497 40.1111 34.1797 40.3401 34.0497 40.5401C33.9097 40.7401 33.7307 40.8801 33.4897 40.9701C33.3087 41.0401 32.8897 41.1301 31.8597 41.1301H30.9297V38.5801H31.7297C32.4897 38.5801 32.9997 38.6001 33.2397 38.6501C33.5397 38.7001 33.7797 38.8301 33.9687 39.0491C34.1597 39.2501 34.2497 39.5201 34.2497 39.8501Z" fill="#CD4527" />
                ...
                <p className='font-medium'><a href={item?.pitchDeck} target='_blank'>pitch_deck.ppt</a></p>
              </div>
            ))
              : <p>No Elevator Pitch found</p>}
        ...
        <div className='w-full sm:w-1/2 flex flex-col gap-5'>
          <div className="bg-[#FAFBFB] rounded-lg p-8">
            ...
            <div className='font-bold text-xl mr-2 whitespace-nowrap'>Debt Information</div>
            <div className="flex mt-3">
              <div className="w-full sm:w-1/2 mb-4">
                ...
                <input
                  ...
                  name="debts"
                  disabled
                  value={campaign?.company?.debt == false ? "No" : "Yes"}
                  placeholder="Libbie"
                  className="block w-full px-2 py-2 text-base font-semibold text-[#111827] bg-white border rounded focus:border-purple-400 focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40 placeholder:text-gray-400 border-gray-400"
                />
              </div>
            ...
            <div className="flex flex-col sm:flex-row sm:gap-3 mt-3">
              <div className="w-full sm:w-1/2 mb-4">
                <label htmlFor="fname" className="block text-base font-medium text-gray-800">
                  Bank Document
                </label>
                <div className="flex flex-row mt-3 gap-3 items-center">
                  <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
