                            ...
                            <div className='pt-4'>
                                <div className="text-sm font-normal breadcrumbs">
                                    <ul>
                                        ...
                                        <li className='text-secondary'>Companies</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className='flex justify-end'>
                            <button className='bg-[#2626ea] text-white p-2 rounded-md'>Add Company</button>
                        </div>
                                        ...
                                        <thead className="border-secondary-light border-b">
                                            <tr>
                                                ...
                                                <th scope="col" className="px-6 py-3 text-lg font-bold text-left text-secondary capitalize">
                                                    <span className="inline-flex items-center justify between">Company Name
