                ...
                <div className='px-2 sm:px-4'>
                    <div className="overflow-x-auto w-full">
                        <div className='flex flex-wrap items-center justify-between'>
                            <div className='pt-4'>
                                <h3 className='font-bold text-xl text-secondary'>History <span className='text-xl font-bold text-secondary-light'>({campaigns && campaigns?.totalResults ? campaigns.totalResults : 0})</span></h3>
                            </div>
                            <div className='pt-4'>
                                <div className="text-sm font-normal breadcrumbs">
                                    <ul>
                                        <li><Link to='/dashboard' className='text-primary'>Dashboard</Link></li>
                                        <li className='text-secondary'>History</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tbody className="divide-y border-secondary-light">
                                            {campaigns && campaigns.results && campaigns.results.length ?
                                                campaigns.results.map((item) => (
                                                    <tr key={item.id}>
                                                        <td className="px-6 text-lg font-normal text-secondary whitespace-nowrap capitalize text-left">
                                                            <div className='flex justify-between mx-4'>
                                                                ...
                                                                <div className='flex gap-20 items-center'>
                                                                    {moment(item.createdDate).fromNow()} <br />
                                                ...
                                                <div className="w-full flex flex-col fixed items-center justify-center mt-20">
                                                    <p className="text-lg">There are no history to show</p>
                                                </div>
                                            }
                                        </tbody>
                                    </table>
