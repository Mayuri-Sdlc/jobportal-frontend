                ...
                <div className='px-2 sm:px-4'>
                    <div className="overflow-x-auto w-full">
                        <div className='flex flex-wrap items-center justify-between'>
                            <div className='pt-4'>
                                <h3 className='font-bold text-xl text-secondary'>All Startup <span className='text-xl font-bold text-secondary-light'>({campaigns && campaigns?.totalResults ? campaigns.totalResults : 0})</span></h3>
                            </div>
                            <div className='pt-4'>
                                                ...
                                                {campaigns && campaigns.results && campaigns.results.length ?
                                                    campaigns.results.map((item) => (
                                                        <tr key={item.id}>
                                                            ...
                                                            <td className="px-6 py-4 text-lg font-normal text-secondary whitespace-nowrap capitalize text-left"><Link to={`/startup/${item?.id}`}>{item.campaignName}</Link></td>
                                                            ...
                                                            <td className="px-6 py-4 text-lg font-normal text-secondary whitespace-nowrap capitalize text-left">
                                                                <span
                                                                    className={`inline-block whitespace-nowrap rounded-[0.27rem] ${item.isVerified == "approve" ? "bg-[#EAF6ED] border-[#AAD8B6] text-[#539F56]" : "bg-[#FFF9E8] border-[#FEE4A0] text-[#F2C046]"} border px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-base font-medium leading-none`}>
                                                                    {item.isVerified}
                                                                </span>
                                                            </td>
