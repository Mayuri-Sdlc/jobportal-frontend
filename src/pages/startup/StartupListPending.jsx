                ...
                <div className='px-2 sm:px-4'>
                    <div className="overflow-x-auto w-full">
                        <div className='flex flex-wrap items-center justify-between'>
                            <div className='pt-4'>
                                <h3 className='font-bold text-xl text-secondary'>Pending Startup <span className='text-xl font-bold text-secondary-light'>({campaigns && campaigns?.totalResults ? campaigns.totalResults : 0})</span></h3>
                            </div>
                            <div className='pt-4'>
                                            ...
                                            <tbody className="divide-y border-secondary-light">
                                                {campaigns && campaigns.results && campaigns.results.length ?
                                                    campaigns.results.map((item) => (
                                                        ...
                                                        </tr>)) : <p>There are no pending startup</p>
                                                }
                                            </tbody>
                                        </table>
                                    </div>
...
export default StartupListPending