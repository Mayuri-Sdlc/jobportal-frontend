...
import { getAllSystemUsers } from '../../features/user/userSlice'
...
const SystemUserList = () => {
  ...
  useEffect(() => {
    dispatch(getAllSystemUsers(optionsData))
  }, [pageNumber, limit])
        ...
        <div className='px-2 sm:px-4'>
          <div className="overflow-x-auto w-full">
            <div className='flex flex-wrap items-center justify-between'>
              <div className='pt-4'>
                <h3 className='font-bold text-xl text-secondary'>System User <span className='text-xl font-bold text-secondary-light'>({users && users?.totalResults ? users.totalResults : 0})</span></h3>
              </div>
              <div className='pt-4'>
                <div className="text-sm font-normal breadcrumbs">
                  <ul>
                    <li><Link to='/dashboard' className='text-primary'>Dashboard</Link></li>
                    <li className='text-secondary'>System User</li>
                  </ul>
                </div>
              </div>
            </div>
                    ...
                    <tbody className="divide-y border-secondary-light">
                      {users && users.results && users.results.length ?
                            ...
                            <td className="px-6 py-4 text-lg font-normal text-secondary whitespace-nowrap capitalize text-left">
                              <div className='flex gap-3 items-center'>
                                ...
                                <div>
                                  ...
                                  <p className='text-sm font-normal text-[#6B788E]'>{''}</p>
                                </div>
                              </div>
                            </td>
                        ...
                        <div className="w-full flex flex-col fixed items-center justify-center mt-20">
                          <p className="text-lg">There are no system users</p>
                        </div>
                      }
                    </tbody>
                  </table>
