...
const ProfileBasicStartup = ({ investor }) => {
      ...
      <div className='flex flex-col sm:flex-row w-full gap-6'>
        ...
        <div className='w-full sm:w-1/2 flex flex-col gap-5'>
          ...
          <div className="bg-[#FAFBFB] rounded-lg p-8">
            <div className="font-bold text-xl mr-2 whitespace-nowrap">Company Details</div>
          ...
          <div className="bg-[#FAFBFB] rounded-lg p-8">
            ...
            <div className="p-2 flex-auto">
              <div className={activeTab === 0 ? "flex flex-wrap gap-2" : "hidden"}>
                <CloseButton text="EduTech" />
                <CloseButton text="Artificial Technology" />
                <CloseButton text="Food" />
              </div>
              <div className={activeTab === 1 ? "flex flex-wrap gap-2" : "hidden"}>
                <CloseButton text="Stage 1" />
                <CloseButton text="Stage 2" />
              </div>
              <div className={activeTab === 2 ? "flex flex-wrap gap-2" : "hidden"}>
                <CloseButton text="$100" />
              </div>
              <div className={activeTab === 3 ? "flex flex-wrap gap-2" : "hidden"}>
                <CloseButton text="Personal" />
              </div>
            </div>
          </div>
        </div>
...
export default ProfileBasicStartup